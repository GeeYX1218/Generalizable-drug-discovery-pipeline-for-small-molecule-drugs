...
## **⚙️ Detailed Configuration Guide (Crucial)**
...
BOX_SIZE = 20.0 # Size of the search space (Angstroms) EXHAUSTIVENESS = 8 # How hard Vina searches for poses (1-8 is standard)
```
